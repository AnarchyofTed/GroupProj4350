...
def MakeDataBase(serverName,databaseName):
    ...
    MainServer.command("""INSERT INTO orders(customer_id, employee_id, order_date, order_price, store_id, payment_type, delivery_date, active)VALUES
    ...
    MainServer.command("""INSERT INTO item(item_price, item_description, quantity_inStock)VALUES
    ...
    MainServer.command("""INSERT INTO set_item(item_Id, set_itemQuantity, set_id)VALUES
